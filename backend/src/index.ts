...
import pitDeclarationsRouter from './routes/pit-declarations';
...
import { scheduleGhostScan } from './jobs/GhostScanJob';
...
import adminGdtDiagnoseRouter from './routes/admin-gdt-diagnose';
...
app.use('/api/pit-declarations', pitDeclarationsRouter);
app.use('/api/admin', adminRouter);
app.use('/api/admin/proxies', adminProxyRouter);
app.use('/api/admin/gdt-diagnose', adminGdtDiagnoseRouter);
